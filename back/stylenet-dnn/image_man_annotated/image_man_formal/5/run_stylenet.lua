...
local initial_picture_id = 1274
local last_data = 1537
local size = last_data - initial_picture_id + 1 - 10

for id = initial_picture_id, initial_picture_id + size - 1, 1 do
   images[id-initial_picture_id] = "man_formal"..string.format("%05d",id)..".jpeg"
end
